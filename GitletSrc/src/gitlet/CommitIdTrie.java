...
public class CommitIdTrie implements Serializable {
    // How deep the gitlet.CommitIdTrie is, starting from 0 as the top level, and the one below as 1, and so on, increasing by 1 every time the trie goes deeper
    private int depth;
    ...
    public void testAddCommitId01() {
        ...
        gitlet.CommitIdTrie commitIdTrie = new gitlet.CommitIdTrie();
