...
public class Repository {
    ...
    public static void status() {
        ...
        System.out.println("=== Modifications Not Staged For gitlet.Commit ===");
    ...
    public void testSplitPoint() {
        ...
        gitlet.Commit commit6 = new gitlet.Commit();
        commit6.setParent(commit5);
        commit6.addCommitDetail("6");
        commit5.setNext(commit6);
        gitlet.Commit commit3 = new gitlet.Commit();
        ...
        Utils.writeObject(INITIAL_COMMIT, initCommit);
        System.out.println(gitlet.Commit.getSplitPoint(commit4, commit2).getMessage());
    }
     */
}
